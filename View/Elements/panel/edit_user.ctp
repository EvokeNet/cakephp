  ...
  <p>I'm a cool paragraph that lives inside of an even cooler modal. Wins!</p> -->
	...
	<div class="row">
		<div class="large-12 columns">
			<?= $this->Form->input('name', array('label' => __('Name'), 'required' => true, 'value' => $m['User']['name'])) ?>
		</div>
	</div>
	<div class="row">
		<div class="large-12 columns">
			<?= $this->Form->input('username', array('label' => __('Username'), 'value' => $m['User']['username'])) ?>
		</div>
	</div>
	<div class="row">
		<div class="large-12 columns">
			<?= $this->Form->input('email', array('type' => 'email', 'required' => true, 'value' => $m['User']['email'])) ?>
		</div>
	</div>
	<div class="row">
	...
	<div class="row">
		<div class="large-6 columns">
			<?= $this->Form->input('website', array('label' => __('Website'), 'value' => $m['User']['website'])) ?>
		</div>
		<div class="large-6 columns">
		 	<?= $this->Form->input('blog', array('label' => __('Blog'), 'value' => $m['User']['blog'])) ?>
		</div>
	</div>
	<div class="row">
		<div class="large-6 columns">
			<?= $this->Form->input('facebook', array('label' => __('Facebook'), 'value' => $m['User']['facebook'])) ?>
		</div>
		<div class="large-6 columns">
	...
	<div class="row">
		<div class="large-6 columns">
			<?= $this->Form->input('country' , array( 'options' => array(
	            ...
	            )), array('label' => __('Country'), 'required' => true, 'value' => $m['User']['country']));
            ?>
		</div>
		<div class="large-6 columns">
		 	<?= $this->Form->input('sex', array('type' => 'radio', 'required' => true, 'value' => $m['User']['sex'], 'options' => array(__('male'), __('female')), 'legend' => '', 'before' => '<label for = "UserSex">'.__('Sex').'</label>')) ?>
		</div>
	</div>
	<div class="row">
		<div class="large-12 columns">
