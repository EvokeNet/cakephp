...
<div class = "evoke menu-bg sidebar menucolumn">
	<ul>
	  ...
	  <li <?=$evokationslink?>><a href="<?= $this->Html->url(array('plugin' => 'forum', 'controller' => 'forum', 'action' => 'index')) ?>"><i class="fa fa-comments" style="padding-right: 10px;"></i></i><?= strtoupper(__('Forum')) ?></a></li>
