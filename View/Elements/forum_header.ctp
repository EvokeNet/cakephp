  ...
  <nav class="top-bar row full-width-alternate" data-topbar>
    <ul class="title-area">
	    <li class="name padding top-03">
	      <h1><a href="<?php echo $this->Html->url(array('controller'=>'users', 'action' => 'dashboard', $user['id'])); ?>"><?= ('Evoke') ?></a></h1>
	    </li>
	  ...
	  <section class="top-bar-section">
	    ...
	    <ul class="right top-bar-background">
	      ...
	      <li class="active" id = "top-bar-name">
	      	...
	      	<?php if(isset($user)) :?>
				<a href="<?php echo $this->Html->url(array('controller'=>'users', 'action' => 'profile', $user['id'])); ?>"><span><?= $user['name'] ?></span></a>
			<?php else :?>
	      ...
	      <li class="has-dropdown">
	        ...
	        <ul class="dropdown">
	          	<?php if(isset($user['User'])) :?>
					<li><a href="<?= $this->Html->url(array('controller' => 'users', 'action' => 'edit', $user['id'])) ?>"><i class="fa fa-pencil-square-o"></i>&nbsp;&nbsp;&nbsp;<?= __('Edit information') ?></a></li>
