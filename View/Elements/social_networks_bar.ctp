...
<a href="<?= $user['User']['facebook'] ?>" 
	class="button-icon <?= (is_null($user['User']['facebook']) ? 'disabled' : '') ?>"
...
<a href="<?= $user['User']['twitter'] ?>" 
	class="button-icon <?= (is_null($user['User']['twitter']) ? 'disabled' : '') ?>"
...
<a href="<?= $user['User']['instagram'] ?>" 
	class="button-icon <?= (is_null($user['User']['instagram']) ? 'disabled' : '') ?>"
...
<a href="<?= $user['User']['website'] ?>" target="_blank"
	class="button-icon <?= (is_null($user['User']['website']) ? 'disabled' : '') ?>"
...
<a href="<?= $user['User']['blog'] ?>" 
	class="button-icon <?= (is_null($user['User']['blog']) ? 'disabled' : '') ?>"
...
<a href="<?= $user['User']['email'] ?>" 
	class="button-icon <?= (is_null($user['User']['email']) ? 'disabled' : '') ?>"
