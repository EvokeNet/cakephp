<nav class="top-bar" data-topbar>
	...
	<section class="evoke top-bar-section">
		...
		<ul class="evoke right">
			...
			<li><a href="<?php echo $this->Html->url(array('controller'=>'users', 'action' => 'dashboard', $user['User']['id'])); ?>"><img src='<?= $this->webroot.'img/Leslie_Knope.png' ?>' class = "evoke top-bar icon"/></a></li>
