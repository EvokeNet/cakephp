<div class="forumTopics index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('forum_categorie_id'); ?></th>
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($forumTopic['ForumCategorie']['title'], array('controller' => 'forum_categories', 'action' => 'view', $forumTopic['ForumCategorie']['id'])); ?>
		</td>
