<div class="forumTopics index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('forumPost_count'); ?></th>
			<th><?php echo $this->Paginator->sort('firstPost_id'); ?></th>
			<th><?php echo $this->Paginator->sort('lastPost_id'); ?></th>
			<th><?php echo $this->Paginator->sort('lastUser_id'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($forumTopic['ForumTopic']['forumPost_count']); ?>&nbsp;</td>
		<td><?php echo h($forumTopic['ForumTopic']['firstPost_id']); ?>&nbsp;</td>
		<td><?php echo h($forumTopic['ForumTopic']['lastPost_id']); ?>&nbsp;</td>
		<td><?php echo h($forumTopic['ForumTopic']['lastUser_id']); ?>&nbsp;</td>
