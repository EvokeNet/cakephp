						...
						<div class="content">
							...
							<div class="button-bar phases-bar padding top-05 bottom-05">
								<ul class="button-group radius">
									...
									<!-- <li>
										<a href="<?= (isset($loggedIn) && ($loggedIn)) ? $mission_url.'/2' : '#' ?>" class="button small thin present font-weight-bold">
											<i class="fa fa-fighter-jet fa-lg"></i> <?= __('Imagine') ?>
										</a>
									</li>
									<li>
										<a href="<?= (isset($loggedIn) && ($loggedIn)) ? $mission_url.'/3' : '#' ?>" class="button small thin disabled font-weight-bold">
											<i class="fa fa-eye fa-lg"></i> <?= __('Act') ?>
										</a>
									</li>
									<li>
										<a href="<?= (isset($loggedIn) && ($loggedIn)) ? $mission_url.'/4' : '#' ?>" class="button small thin disabled font-weight-bold">
