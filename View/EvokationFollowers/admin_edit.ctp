...
<?php echo $this->Form->create('EvokationFollower'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Evokation Follower'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('EvokationFollower.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('EvokationFollower.id'))); ?></li>
