...
<?php echo $this->Form->create('UserMatchingAnswer'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit User Matching Answer'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('UserMatchingAnswer.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('UserMatchingAnswer.id'))); ?></li>
