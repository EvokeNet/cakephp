...
<section class="evoke margin top-2">
	<div class="row evoke-max-width">
	  <div class="small-11 small-centered columns">
		  ...
		  <a class="current" href="#"><?php echo __('Learn');?></a>
		</nav>

		<!-- <div class="nice secondary progress large-3" style = "height:2.5em">
			<span class = "meter" style = "width:50%">Some text</span>
		</div> -->
		...
		<?php foreach ($mission['Quest'] as $quest): ?>
			...
			<!-- Button for lightbox containing a quest -->			
