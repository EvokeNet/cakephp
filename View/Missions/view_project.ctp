		...
		<div class = "small-9 medium-9 large-9 columns maincolumn">
			...
			<div class = "evoke missions header tint">
				...
				<?php if(!is_null($mission['Mission']['cover_dir'])) :?>
					<img src="<?= $this->webroot.'files/attachment/attachment/'.$mission['Mission']['cover_dir'].'/'.$mission['Mission']['cover_attachment'] ?>" style = "width: 100%; height:22vw">
                <?php else :?>
					<img src = '<?= $this->webroot.'img/E01G01P02.jpg' ?>' style = "width: 100%; height:22vw">
                <?php endif ?>
			</div>
			...
			<div class="row full-width-alternate">
			  <div class="small-9 medium-9 large-9 columns">
				  ...
				  <dd><a href="#panel2-4"><?= strtoupper(__('Evokations Stream')) ?></a></dd>
				</dl>
				<div class="evoke content-block default tabs-content mission tabs">
				  ...
				  <div class="content" id="panel2-4">
				    ...
				    <dl class="default tabs" data-tab>
						  <dd class="active"><a href="#panel12-1"><?= strtoupper(__('Latest Projects'))?></a></dd>
						  <dd><a href="#panel12-2"><?= strtoupper(__('Successfully Launched Projects'))?></a></dd>
						</dl>
					<div class="evoke content-block default tabs-content mission tabs">
