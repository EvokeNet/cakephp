	...
	<div class="row full-width">
	  ...
	  <div class="medium-3 large-3 columns padding-right">
		...
		<div class = "evoke evidence-share">
		  	...
		  	<!-- like button -->
		  	<?php if(empty($like)) : ?>
		  		<div  onClick="location.href='<?php echo $this->Html->url("controller" => "likes", "action" => "like", $evidence['Evidence']['id']); ?>'" class="evoke button-bg"><div class="evoke button like-button"><i class="fa fa-heart-o fa-lg"></i>&nbsp;&nbsp;<h6><?= __('Like');?></h6></div><span><?= count($likes) ?></span></div>
			<?php else : ?>
				<div  onClick="location.href='<?php echo $this->Html->url("controller" => "likes", "action" => "like", $evidence['Evidence']['id']); ?>'" class="evoke button-bg"><div class="evoke button like-button"><i class="fa fa-heart fa-lg"></i>&nbsp;&nbsp;<h6><?= __('Unlike');?></h6></div><span><?= count($likes) ?></span></div>
			<?php endif; ?>
