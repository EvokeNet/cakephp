...
<h2><?php echo __('Forum'); ?></h2>
	<dl>
		...
		<dt><?php echo __('LastTopic Id'); ?></dt>
		<dd>
			<?php echo h($forum['Forum']['lastTopic_id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('LastPost Id'); ?></dt>
		<dd>
			<?php echo h($forum['Forum']['lastPost_id']); ?>
			&nbsp;
		</dd>
...
<div class="related">
	...
	<tr>
		...
		<th><?php echo __('ForumPost Count'); ?></th>
	...
	<?php foreach ($forum['ForumTopic'] as $forumTopic): ?>
		<tr>
			...
			<td><?php echo $forumTopic['content']; ?></td>
			<td><?php echo $forumTopic['status']; ?></td>
			<td><?php echo $forumTopic['view_count']; ?></td>
			<td><?php echo $forumTopic['forumPost_count']; ?></td>
